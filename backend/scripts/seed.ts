...
async function bootstrap() {
  ...
  // Experiences
  const experiences = loadJson<ExperienceInput>('experiences.json');
  ...
  // Skills
  const skills = loadJson<SkillInput>('skills.json');
  ...
  // Pitches
  const pitches = loadJson<PitchInput>('pitches.json');
  ...
  // Rules
  const rules = loadJson<RuleInput>('rules.json');
