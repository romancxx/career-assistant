    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-600">
          Paste a job description. PitchForge will retrieve your relevant experience and write a
          pitch.
        </p>
      </div>

      <GenerateForm generating={generator.generating} onGenerate={generator.handleGenerate} />
